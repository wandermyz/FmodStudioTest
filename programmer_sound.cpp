...
int FMOD_Main()
{
    ...
    ERRCHECK( system->getEvent("event:/Character/Radio Dialogue", &eventDescription) );
...
FMOD_RESULT F_CALLBACK programmerSoundCallback(FMOD_STUDIO_EVENT_CALLBACK_TYPE type, FMOD_STUDIO_EVENTINSTANCE* event, void *parameters)
{
    ...
    if (type == FMOD_STUDIO_EVENT_CALLBACK_CREATE_PROGRAMMER_SOUND)
    {
        ...
        CHECK_RESULT( context->system->createSound(context->soundName, FMOD_LOOP_NORMAL | FMOD_CREATECOMPRESSEDSAMPLE | FMOD_NONBLOCKING, NULL, &sound) );
