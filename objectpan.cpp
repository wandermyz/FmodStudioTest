...
int FMOD_Main()
{
    ...
    if (result != FMOD_OK)
    {
        ...
        if (result == FMOD_OK)
        {
            ERRCHECK( lowLevelSystem->setDSPBufferSize(480, 4) );
    ...
    FMOD::Studio::Bank *objectBank = NULL;
    ...
    ERRCHECK( system->loadBankFile(Common_MediaPath("Object Panning.bank"), FMOD_STUDIO_LOAD_BANK_NORMAL, &objectBank) );
